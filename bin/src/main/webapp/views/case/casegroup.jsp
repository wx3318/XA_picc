...
<html>
  ...
  <body>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 月任务设置
                    </div>
                            ...
                            <form class="am-form am-form-horizontal" id="groupcase-add-form"  >
                              ...
                              <input name="SesionToken" value="${SesionToken }"  type="hidden"/>   
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="number" id="challengNumber" name="challengNumber" placeholder="请输入初始结案数量" required  min="0" max="99999" pattern="^\+?[0-9][0-9]*$">
                                    </div>
                                </div>
                                <div class="am-form-group">
            ...
            <script type="text/javascript" src="${basePath}/statics/js/case/addgroupcase.js"></script>
  </body>
