			...
			<div class="tpl-portlet-components">
				<div class="portlet-title">
					<div class="caption font-green bold">
						<span class="am-icon-code"></span>车险结案率报表
					</div>
				</div>
				<div class="tpl-block">
					<div class="am-g">
								...
								<div class="am-u-sm-6 am-u-lg-3 am-custom-top am-padding-left-0">
									<div class="am-input-group am-input-group-primary am-input-group-sm">
										...
										<select name="year" id="year">
											<option>--请选择--</option>
											<c:forEach items="${closingRateYearList}" var="year">
												<option value="${year}">
													          ${year}
												</option>
											</c:forEach>
							...
							<div class="am-u-sm-12">
								...
								<table width="100%" border="0" id="groupcaseTable" class="am-table am-table-striped am-table-hover table-main">
									<thead id="countId1">
										...
										<tr>
											<td rowspan="3" style="vertical-align:middle">归属</td>
											<td colspan="3" style="text-align:center;">5000元以下</td>
											<td colspan="3" style="text-align:center;">万元以下</td>
											<td colspan="3" style="text-align:center;">万元以上</td>
										</tr>
										<tr>
											<td style="text-align:center;">立案数(件)</td>
											<td style="text-align:center;">结案数(件)</td>
											<td style="text-align:center;">结案率(%)</td>
											<td style="text-align:center;">立案数(件)</td>
											<td style="text-align:center;">结案数(件)</td>
											<td style="text-align:center;">结案率(%)</td>
											<td style="text-align:center;">立案数(件)</td>
				...
				<script type="text/javascript" src="${basePath}/statics/js/case/closingratelist.js"></script>
