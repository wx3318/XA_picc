...
<body >
	...
	<div class="am-tabs" data-am-tabs>
			  <ul class="am-tabs-nav am-nav am-nav-tabs">
			    <li class="am-active"><a href="#tab1">结案案件</a></li>
  ...
  <div class="am-tabs-bd">
	      ...
	      <div class="portlet-title">
				...
				<div style="margin: 20px;">
					 <form method="POST" enctype="multipart/form-data" onsubmit="return false;"> 
						...
						<input type="button" value="确定上传" class="am-btn am-btn-primary" id="inport_file_closing" onclick="importClosingListExcel()">
					</form>
				</div>
    </div>
    ...
    <div class="am-tab-panel am-fade am-in am-active">
	 ...
	 <script type="text/javascript" src="${basePath}/statics/js/case/closinglistimport.js"></script>
</body>	
</html>