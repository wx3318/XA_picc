...
<html>
  ...
  <body>
                            ...
                            <form class="am-form am-form-horizontal" id="goods-add-form"  >
                              ...
                              <fieldset>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="name" name="name" placeholder="请输入角色名称" required maxlength="50">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="description" name="description" placeholder="请输入角色描述" required maxlength="50">
                                    </div>
                                </div>
           ...
           <script type="text/javascript" src="${basePath}/statics/js/role/role_add.js"></script>
  </body>
